...
Task 3 :
	Fetch all the strings which has 'd' as 3rd character from last
    Pattern : '%d__'
...
Challenge : Fetch all the records from the citizens table whose FirstName has 2nd and 3rd characters 
			as 'a' and 'c' respectively and then 'd' as 2nd character from last .
*/
...
-- Prints out empty table if No records match the given pattern
